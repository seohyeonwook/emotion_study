...
import { useLoadList, useLoadListRyPageNumber } from "../../hooks/boardListHook";
...
function BoardList() {
    ...
    const { boardList,pageNumbers,totalpageCount,startPageNumber } = useLoadListRyPageNumber(page);
